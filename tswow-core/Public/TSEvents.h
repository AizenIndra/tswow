...
void OC_GAME_API ReloadPlayer(std::function<void(TSPlayer, bool)> fn);
void OC_GAME_API ReloadPlayer(sol::protected_function);

void OC_GAME_API ReloadCreature(std::function<void(TSCreature)> fn);
void OC_GAME_API ReloadCreature(std::function<void(TSCreature)> fn, TSNumber<uint32> id);
void OC_GAME_API ReloadCreature(sol::protected_function);
void OC_GAME_API ReloadCreature(sol::protected_function, TSNumber<uint32> id);

void OC_GAME_API ReloadGameObject(std::function<void(TSGameObject)> fn);
void OC_GAME_API ReloadGameObject(std::function<void(TSGameObject)> fn, TSNumber<uint32> id);
void OC_GAME_API ReloadGameObject(sol::protected_function);
void OC_GAME_API ReloadGameObject(sol::protected_function, TSNumber<uint32> id);

void OC_GAME_API ReloadMap(std::function<void(TSMap)> fn);
void OC_GAME_API ReloadMap(std::function<void(TSMap)> fn, TSNumber<uint32> id);
void OC_GAME_API ReloadMap(sol::protected_function);
void OC_GAME_API ReloadMap(sol::protected_function, TSNumber<uint32> id);

void OC_GAME_API ReloadBattleground(std::function<void(TSBattleground)> fn);
void OC_GAME_API ReloadBattleground(std::function<void(TSBattleground)> fn, TSNumber<uint32> id);
void OC_GAME_API ReloadBattleground(sol::protected_function);
void OC_GAME_API ReloadBattleground(sol::protected_function, TSNumber<uint32> id);

void OC_GAME_API ReloadInstance(std::function<void(TSInstance)> fn);
void OC_GAME_API ReloadInstance(std::function<void(TSInstance)> fn, TSNumber<uint32> id);
void OC_GAME_API ReloadInstance(sol::protected_function);
void OC_GAME_API ReloadInstance(sol::protected_function, TSNumber<uint32> id);
...
extern OC_GAME_API TSEvents ts_events;
/*
 * This file is part of tswow (https://github.com/tswow/).
 * Copyright (C) 2020 tswow <https://github.com/tswow/>
 *
